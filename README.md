...
1. **Raspberry Pi 3: $35** Any Raspberry Pi model will work, but the latest version bring a significant performance benfit
2. **Pi Sense Hat: $40** The Pi Sense Hat was design for data collection on the International Space Station. It contains sensors for a 9-dof IMU, as well as 5 button joystick and 8x8 LED array for displaying status
3. **GPS Receiver: $30** RacePi works with any Linux-compatible GPS receivers. High speed drone receivers are available for cheap on Amazon.
